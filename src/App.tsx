...
const PROJECT_METADATA: Record<string, { title: string; description: string }> = {
  "1": {
    title: "Omera Fintech - Case Study | Ayush Nikhade",
    description: "Case study for Omera Fintech, a remittance and financial services hub engineered by Ayush Nikhade. Secure transaction flows, real-time rate displays, and seamless cross-border payment UX."
  },
  "2": {
    title: "Devswipe - Case Study | Ayush Nikhade",
    description: "Case study for Devswipe, a Tinder-like developer matchmaking and networking application engineered by Ayush Nikhade. Connects developers based on skills, interest levels, and stack profiles."
  },
  "3": {
    title: "Verdict AI - Case Study | Ayush Nikhade",
    description: "Case study for Verdict AI, a multilingual legal intelligence and research platform engineered by Ayush Nikhade. Utilizes RAG, hybrid semantic search, and FAISS vector indexing."
  },
  "4": {
    title: "Eternal Ceramic - Case Study | Ayush Nikhade",
    description: "Case study for Eternal Ceramic, a business web storefront and product catalog built for a ceramic and sanitary ware exporter by Ayush Nikhade."
  },
  "5": {
    title: "Connect Four - Case Study | Ayush Nikhade",
    description: "Case study for Connect Four, a classic board game engineered from scratch by Ayush Nikhade using vanilla HTML, CSS, and JavaScript."
  },
  "6": {
...
function App() {
  ...
  useEffect(() => {
    let title = "Ayush Nikhade | Software Engineer & Full Stack Developer"
    let description = "Ayush Nikhade is a Software Engineer and Full Stack Developer specializing in building high-performance web applications with MERN, Generative AI, cloud infrastructure, and modern databases. Explore my portfolio and projects."
