...
const projectsList: Project[] = [
  ...
  },
  {
    index: "6",
    title: "Crowd Sync",
    subtitle: "AI-Powered Bus Fleet Management System",
    description:
      "A full-stack, real-time bus fleet management platform combining an AI-powered edge device, REST/WebSocket backend, admin dashboard, and passenger app.",
    longDescription:
      "Crowd Sync is a full-stack bus fleet management system designed for real-time monitoring of buses, routes, crowd levels, and fleet operations. It connects an AI-powered edge device with a backend service and multiple client interfaces to provide live updates and operational intelligence.",
    frontendStack: ["React", "Vite", "Tailwind CSS", "Leaflet.js", "Chart.js"],
    backendStack: ["Node.js", "Express", "Socket.IO", "PostgreSQL", "Redis"],
    otherStack: ["Python", "OpenCV", "YOLOv8", "React Native", "Expo"],
    problemSolved: "Public transport operators need live visibility into bus occupancy, route performance, and operational health. Crowd Sync brings these signals together into a real-time system that helps reduce overcrowding and improve fleet coordination.",
    architecture: "The system connects a Python-based edge AI device that sends GPS and crowd data every few seconds to a Node.js backend using REST and WebSocket. The backend stores and analyzes data in PostgreSQL and Redis, while the web dashboard and mobile app consume live updates through Socket.IO.",
    category: "PROJECT",
    year: "2026",
    liveUrl: null,
    githubUrl: null,
    ...
    accent: {
      dot: "bg-fuchsia-500",
      glow: "group-hover:border-fuchsia-400/60 dark:group-hover:border-fuchsia-500/40",
      tag: "border-fuchsia-300/50 dark:border-fuchsia-500/20 text-fuchsia-700 dark:text-fuchsia-400 bg-fuchsia-500/5",
      statusColor: "text-fuchsia-600 dark:text-fuchsia-400",
      statusDot: "bg-fuchsia-500",
      shadow: "group-hover:shadow-[0_0_40px_rgba(217,70,239,0.08)] dark:group-hover:shadow-[0_0_40px_rgba(217,70,239,0.06)]",
    },
    features: [
      "Real-time bus location and crowd updates via WebSocket",
      "AI-powered edge device integration for occupancy awareness",
      "Admin dashboard with live fleet maps and analytics",
      "Mobile app experience for passengers and operators"
    ],
    architectureChart: `graph TD
  Edge["Edge AI (Python)" ] --> Backend["Node.js Backend"]
  Backend --> DB[("PostgreSQL")]
  Backend --> Cache[("Redis")]
  Backend --> Dashboard["Web Dashboard"]
  Backend --> Mobile["Mobile App"]
  Dashboard --> Live["Socket.IO Live Updates"]
  Mobile --> Live
        ...
        <section style={{ padding: "20px" }} className="pt-12 border-t border-neutral-200 dark:border-neutral-800 flex flex-col items-center justify-center gap-8 my-16 w-full">
          <div className="flex flex-col items-center text-center gap-2">
            <img
              ...
              alt="Ayush Nikhade profile photo"
