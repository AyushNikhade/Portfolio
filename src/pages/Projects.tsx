...
export const Cards: CardItem[] = [
  ...
  },
  {
    ...
    stack: ["React", "Node.js", "Socket.IO", "Python"],
      ...
      <div className="w-full h-28 border border-violet-300/30 rounded-xl p-2.5 flex flex-col gap-2 bg-violet-500/20 relative overflow-hidden">
        ...
        <div className="flex items-center justify-between relative z-10">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="h-2.5 w-8 rounded-full bg-white/20" />
          </div>
        </div>
        <div className="flex-1 flex gap-2 relative z-10">
          <div className="w-[38%] rounded-lg border border-white/20 p-2 relative overflow-hidden">
            <div className="absolute inset-0 opacity-60 bg-[linear-gradient(90deg,transparent_0%,transparent_28%,rgba(255,255,255,0.2)_28%,rgba(255,255,255,0.2)_50%,transparent_50%,transparent_100%)]" />
            <div className="absolute bottom-2 left-2 right-2 h-8 rounded-full border border-white/20" />
            <div className="absolute left-3 top-3 h-3 w-3 rounded-full border border-white/25" />
            <div className="absolute right-3 bottom-3 h-6 w-6 rounded-full border border-white/20" />
          </div>
          <div className="flex-1 rounded-lg border border-white/20 p-2 flex items-end gap-1">
            {[18, 32, 24, 40, 20].map((height, idx) => (
